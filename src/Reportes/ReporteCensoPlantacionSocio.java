...
public class ReporteCensoPlantacionSocio extends Thread {
	Socio unSocio;
	String temporada;
	private String titulo;
	private Empresa emp;
	
	public ReporteCensoPlantacionSocio(Socio unSocio, String temporada,Empresa emp, String titulo) {
	...
	public void run(){
		try
		{
			...
			String fileName="Reportes/CensoPlantacionSocio.jasper";
			//Obtner una conexi�n a la base de datos
			Connection con = Empresa.con.getConeccion();
			//Pasamos parametros al reporte Jasper.
			Map parameters = new HashMap();
			parameters.put("nroSo", unSocio.getNroSocio());
