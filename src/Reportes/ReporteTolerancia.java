...
public class ReporteTolerancia extends Thread {
        private Empresa emp;	
        private String titulo;
        private String temporada;
	
	
	public ReporteTolerancia(Empresa emp, String titulo, String temporada) {
                this.emp = emp;
               	this.titulo = titulo;
	...
	public void run(){
		try
		{
			...
			String fileName="Reportes/Tolerancia.jasper";
			...
			JasperViewer jviewer = new JasperViewer(jasperPrint,false);
                        jviewer.setTitle("Reporte Tolerancia");
